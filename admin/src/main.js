...
import { Button, Select, Option, OptionGroup, Pagination, Tag, Radio, Row, Col, Form, FormItem, Tabs, TabPane, Checkbox, Input, MenuItem, MenuItemGroup, Container, Header, Aside, Main, Tree, Footer, Submenu, Menu, Loading, Table, TableColumn, dialog } from 'element-ui'
...
Vue.use(Submenu).use(Menu).use(Loading).use(Table).use(TableColumn).use(dialog).use(Tree).use(Radio).use(Option).use(OptionGroup).use(Tag).use(Pagination)
